        ...
        <ul className="menu menu-horizontal w-full">
          <div className="flex justify-center items-center gap-2 text-sm w-full">
            <div className="text-center">
              <a
                href="https://github.com/austintgriffith/impersonator-vision"
                target="_blank"
                rel="noreferrer"
                className="link"
              >
                fork impersonator-vision
              </a>
            </div>
            <span>·</span>
            <div className="flex justify-center items-center gap-2">
              <p className="m-0 text-center">
                built with [<a href="https://www.npmjs.com/package/@impersonator/iframe">@impersonator/iframe</a>] at
              </p>
              <a
